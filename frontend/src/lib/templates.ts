...
type FieldOverrides = Partial<Omit<FormField, "options">> & {
  options?: string[];
};

// Apply field overrides onto a fresh field of the given type
const field = (type: FieldType, overrides: FieldOverrides = {}): FormField => {
...
/* Starter templates.
  Each builds a complete form definition ready to
