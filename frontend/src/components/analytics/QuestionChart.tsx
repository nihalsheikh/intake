...
import { FIELD_DEFS } from "@/lib/fieldTypes";
...
interface QuestionChartProps {
  question: QuestionAnalyticsData;
}
...
const Legend = ({ color, label, value, total }: LegendProps) => {
...
const renderBody = (question: QuestionAnalyticsData): ReactElement => {
  if (question.samples) {
...
export const QuestionChart = ({ question }: QuestionChartProps) => {
