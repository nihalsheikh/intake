...
const VARIANTS: Record<ButtonVariant, string> = {
  ...
  danger:
    "bg-red-600 text-white hover:bg-red-700 shadow-soft active:scale-[.98]",
  outline:
    "border border-brand-300 text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-900/20 active:scale-[.98]",
  subtle:
    "bg-brand-50 text-brand-700 hover:bg-brand-100 dark:bg-brand-900/25 dark:text-brand-200",
};
