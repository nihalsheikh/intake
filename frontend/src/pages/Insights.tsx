...
import { CHART, tooltipStyle } from "@/lib/charts";

interface DeviceMetaItem {
  icon: ComponentType<{ className?: string; style?: Record<string, any> }>;
  color: string;
}
...
interface DeviceStat {
  label: "Desktop" | "Mobile" | "Tablet" | string;
  value: number;
}

interface TopFormItem {
  id: string;
  title: string;
  color?: string;
  responses: number;
...
const DEVICE_META: Record<string, DeviceMetaItem> = {
...
export default function Insights() {
  ...
  useEffect(() => {
    insightsApi
      ...
      .catch((e: any) => toast.error(e?.message || "Failed to load insights"))
  ...
  const responsesDelta = useMemo<number>(() => {
